...
NOTE: Hardware agnostic driver for 1602 style 
	  lcd displays. Application software needs to 
	  provide struct with delay and lcd write function.
	  most high level logic will be handled by this code 
